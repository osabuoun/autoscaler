...
% Page heads
\markboth{O. Abu Oun et al.}{Deadline-Based Container Autoscaler for Cloud Application}

% Title portion
\title{Deadline-Based Container Autoscaler for Cloud Application}
\author{Osama ABU OUN
\affil{University of Westminster}
Tamas Kiss
\affil{University of Westminster}
}
